...
tags:
  - concepts
ogImage: "https://images.unsplash.com/photo-1648443524209-d65b2930a743?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2070&q=80"
description: Don't do more work unless you need to.
---

# Lazy Sequences

Lazy sequences or lazily resolved sequences are highly useful for more situations than you might originally think. Before we talk about their benefits, we first
need to explain what these lazy sequences are and how they work.
...
![alt text](/src/assets/array-diagram.png "Title")
...
![alt text](/src/assets/iterator-diagram.png "Title")
...
## Aside: I think iterators + functional operations are much better.
...
The former code is theoretically twice as slow as the latter. While this particular example is contrived, it may be a performance footgun for some developers. In rust, this situation is mostly avoided by requiring an iterator to use functional operations.
